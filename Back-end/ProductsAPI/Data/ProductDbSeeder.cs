    ...
    public static class ProductDbSeeder
    {
        ...
        public static void Seed(ProductDbContext context)
        {
            var products = new List<Product>
            {
                ...
                new Product { Title = "New Work", Price = 2800.00M, Description = "A contemporary sculpture made of stainless steel", Category = "Art", ImgUrl = "/images/new-work.jpg", InStock = true },
